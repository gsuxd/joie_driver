...
class PedidosCancelarConfirmarUsuario extends StatefulWidget {
  const PedidosCancelarConfirmarUsuario({Key? key}) : super(key: key);
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          "Las cancelaciones frecuentes de carreras afectan su calificacion y puede acarrear suspensiones del servicio",
                          style: TextStyle(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          const PedidosCancelarConfirmar()));
                            },
                            style: ElevatedButton.styleFrom(
