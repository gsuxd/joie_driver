...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Center(
            child: Text("Tu Perfil", style: TextStyle(fontFamily: "Monserrat", fontWeight: FontWeight.bold, fontSize: 20.0), textAlign: TextAlign.center,),
          ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text("Hola", style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
                      Text("Andrea", style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
                      Image.asset("assets/images/estrella5.png", height: 15,),
                    ],
                  ),
                  Container(
                    width: 10,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    itemMenu("Asistencia\Tecnica","assets/images/asistencia_tecnica.svg" ),
                    itemMenu("Notificaciones","assets/images/notificaciones.svg" ),
              ...
              Row(
                children: [
                  ...
                  Text("Mi Cuenta", style: TextStyle(color: Colors.black87, fontSize: 20.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),)
                ...
                children: [
                  Container(
                    width: 20.0,
                      ...
                      Text("Saldo", style: TextStyle(color: Colors.black87, fontSize: 16.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),),
                      Container(
                        width: 100.0,
                      ),
                      Text("56.000 \$", style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
                  Container(
                    width: 10.0,
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Calificacion", style: TextStyle(color: Colors.black87, fontSize: 16.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),),
                  Container(
                   child: FutureBuilder(
                     future: stars(),
              ...
              Row(
                children: [
                  ...
                  Text("Refiere y Gana", style: TextStyle(color: Colors.black87, fontSize: 20.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),)
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Invitar Parcero", style: TextStyle(color: Colors.black87, fontSize: 16.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),),
                  Container(
                    width: 70.0,
                  ),
                  Text(" ", style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
                  Container(
                    width: 10.0,
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  Text("Conoce Nuestros\nbeneficios", style: TextStyle(color: Colors.black87, fontSize: 16.0, fontFamily: "Monserrat", fontWeight: FontWeight.bold),),
                  Container(
                    width: 50.0,
                  ),
                  Text(" ", style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
 ...
 Future<Row>  stars() async {
   ...
   return  calificacionPonderada.get().then((value) =>
        dibujarEstrellas(3.7));
  ...
  Row dibujarEstrellas(calificacion) {
    ...
    if(calificacion == null){
      return Row(
        children: [
          ...
          Text(calificacionPonderada, style: TextStyle(fontSize: 16, fontFamily: "Monserrat", fontWeight: FontWeight.bold, color: blue),),
    ...
    if(calificacion >= 0.5 && calificacion < 1){
      calificacionPonderada = double.parse((calificacion).toStringAsFixed(1)).toString();
      return Row(
        children: [
