...
class _OfertaState extends State<Oferta> {
          ...
          children: [
            ListView(
              ...
              children: [
                ...
                Visibility(
                  visible: solicitar,
                  child: ofertaItem(context, "Vicente Rojas","assets/images/estrella5.png", 50.0, 3, "assets/images/girld2.jpg" ),
                ),
                Visibility(
                  visible: solicitar,
                  child: ofertaItem(context, "Vicente Rojas","assets/images/estrella5.png", 50.0, 3, "assets/images/girld2.jpg" ),
            ...
            Positioned(
                ...
                child: Container(
                  ...
                  children: [
                    Text("Ofertas de Conductores", style: TextStyle(color: Colors.white, fontFamily: "Monserrat", fontSize: 18, fontWeight: FontWeight.bold,),),
                  ],
                  )
                ))),
          ],
  ...
  Container ofertaItem(BuildContext context, String name, String rate, double price, int min, String url_img) {
    return Container(
                margin: EdgeInsets.only(top: 0.0, bottom: 5.0, left: 10.0, right: 10.0),
                height: 120,
                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(name, style: TextStyle(fontFamily: "Monserrat",color: Colors.grey,fontWeight: FontWeight.bold ),),
                            Image.asset(rate, height: 15,)
                          ],
                        )
                      ],
                    ),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("$price \$", style: TextStyle(fontFamily: "Monserrat",color: Colors.black87, fontWeight: FontWeight.bold),),
                          Text("$min min", style: TextStyle(fontFamily: "Monserrat",color: blue, fontWeight: FontWeight.bold ),),
                        ],
                      ),
                      Container(
                        width: 10.0,
                    ...
                    children: [
                      Container(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text("Declinar", style: TextStyle(fontFamily: "Monserrat",color: Colors.white, fontWeight: FontWeight.bold),),
                          ),
                        ),
                      Container(
                        width: 10.0,
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text("Aceptar", style: TextStyle(fontFamily: "Monserrat",color: Colors.white, fontWeight: FontWeight.bold),),
                        ),
                      ),
                      Container(
                        width: 10.0,
