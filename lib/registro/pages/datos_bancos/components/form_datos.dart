    ...
    return Column(
      children: [
        ...
        ButtonDefChofer(
          text: 'Siguiente',
          press: () {
            data!.registroDataBank!.nameComplete = controllerTextName.text;
            data!.registroDataBank!.numberBank = controllerTextNumber.text;
            data!.registroDataBank!.numberCi = controllerTextCedula.text;
            data!.registroDataBank!.bank = bancoChofer;
            data!.registroDataBank!.typeBank = tipoCuenta2;
            data!.registroDataBank!.dateCi = controllerTextDate;
