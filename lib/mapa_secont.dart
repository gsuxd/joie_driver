...
class MapaSecont extends StatefulWidget {
  ...
  MapaSecont({ required double this.latitude, required double this.longitude, required this.isSwitched, required this.state});
  static const String routeName = '/Register';
  @override
  createState() =>  _MapaSecontState(latitude: latitude, longitude: longitude, state: state, isSwitched: isSwitched);
}
...
class _MapaSecontState extends State<MapaSecont> {
  ...
  _MapaSecontState({ required double this.latitude, required double this.longitude , required this.isSwitched, required this.state});
  @override
            ...
            Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Carrera en curso", style: TextStyle(fontFamily: "Monserrat", fontSize: 20.0, color: Colors.black87),),
                    Container(
                      height: 10.0,
                    ),
                    Text("Ya puede escribirle al pasajero", style: TextStyle(fontFamily: "Monserrat", fontSize: 16.0, color: blue),),
                    Container(
                      height: 10.0,
                    ),
                    requestClient(context, "Andrea Guzman","assets/images/estrella5.png", "assets/images/girld2.jpg" ),
                  ],
                ),
              ),
             ],
  ...
  Container requestClient(BuildContext context, String name, String rate, String url_img) {
    return Container(
              ...
              children: [
                ...
                Row(
                    children: [
                      ...
                      GestureDetector(
                        child: Icon(Icons.message_rounded, color: blue,),
                      ),
                      Container(
                        width: 10,
                      ),
