    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
            Column(
              children: [
                SvgPicture.asset("assets/images/imagenasistencia.svg", width: MediaQuery.of(context).size.width,),
                item("Problemas de localizacion", "assets/images/problemas_de_geo_localizacion.svg"),
                Container(height: 15.0,),
                item("No puedo pedir viaje", "assets/images/no_puedo_pedir_carro.svg"),
                Container(height: 15.0,),
                item("Mi cuenta se reinicia", "assets/images/se_reinicia_mi_cuenta.svg"),
                Container(height: 15.0,),
                item("Mi calificacion esta mal", "assets/images/mi_calificacion_esta_mal.svg"),
                Container(height: 15.0,),
                item("No puedo actualizar mis datos", "assets/images/no_puedo_actualizar_mis_datos.svg"),
                Container(height: 15.0,),
          ...
          children: [
            ...
            Container(
              ...
              child: ElevatedButton(onPressed: (){
                final _reporte = Reporte("UsuarioPrueba", "Pasajero", title, _controllerText.text, DateTime.now(),);
