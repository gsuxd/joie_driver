...
class MapaSecontUsuario extends StatefulWidget {
  ...
  MapaSecontUsuario({ required double this.latitude, required double this.longitude, required this.state});
                  ...
                  Container(
                    ...
                    Row(
                      children: [
                        ...
                        Text("Plaza Bolivar Sabana Grande", style: TextStyle(color: Colors.black45, fontFamily: "Monserrat", fontSize:12),)
                      ],
                    ),
                  Container(
                    margin: EdgeInsets.only(top: 10,),
                      ...
                      TextField(
                        ...
                        onChanged: (text){
                          setState(() {
                            ...
                            if(colorPuntoB == blue && colorPasajero == blue && colorPrecio == blue){
                              solicitar = true;
                            }else{
                              solicitar = false;
                            }
                        ...
                        decoration: InputDecoration(
                          labelText: 'Destino',
                          labelStyle: TextStyle(color: colorLabel, fontFamily: "Monserrat", fontSize: 12),
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: colorLabel2, fontFamily: "Monserrat", fontSize: 12),
                          //border: OutlineInputBorder( borderRadius: BorderRadius.all(Radius.circular(15.0)), borderSide: BorderSide(color: Colors.white, width: 2),),
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.all(Radius.circular(0.0)),
                            borderSide: BorderSide(color: Colors.grey, width: 0),
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: colorLabel3, fontFamily: "Monserrat", fontSize: 12),
                          //border: OutlineInputBorder( borderRadius: BorderRadius.all(Radius.circular(15.0)), borderSide: BorderSide(color: Colors.white, width: 2),),
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.all(Radius.circular(0.0)),
                            borderSide: BorderSide(color: Colors.grey, width: 0),
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle: TextStyle(color: colorLabel4, fontFamily: "Monserrat", fontSize: 12),
                          //border: OutlineInputBorder( borderRadius: BorderRadius.all(Radius.circular(15.0)), borderSide: BorderSide(color: Colors.white, width: 2),),
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.all(Radius.circular(0.0)),
                            borderSide: BorderSide(color: Colors.grey, width: 0),
                    ...
                    visible: solicitar,
                      child: ElevatedButton(onPressed: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PedidoAceptado(state: state, longitude: longitude, latitude: latitude,)));
                      },
                          ...
                          child: Container(
                              ...
                              child: Text("Solicitar Viaje", style: TextStyle(color: Colors.white, fontFamily: "Monserrat"),))
                      )),
                ],
              ),
            ),
