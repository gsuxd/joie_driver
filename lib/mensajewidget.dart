...
class MensajeWidget extends StatelessWidget {
  ...
  Column sms() {
    ...
    children: [
      Padding(
          padding: const EdgeInsets.only(left: 40.0, top: 5, right: 1.0, bottom: 2),
          child:
         Column(
  ...
  Column sms2() {
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.only(left: 1.0, top: 5, right: 40.0, bottom: 2),
          child:
          Column(
              ...
              children: [
                ...
                Padding(
                    ...
                    child: Align(
                        alignment: Alignment.topRight,
                        child: Text(
                            DateFormat('kk:mm a, dd-MM-yyyy').format(fecha).toString(),
                            style: TextStyle(color: Colors.grey)
                        ))
                )
              ]
