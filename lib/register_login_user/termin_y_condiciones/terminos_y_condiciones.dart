...
//Aca empieza todo
class TerminosCondicionesUser extends StatefulWidget {
  const TerminosCondicionesUser({Key? key}) : super(key: key);

  @override
  State<TerminosCondicionesUser> createState() => _TerminosCondicionesState();
}

//Aca colocaremos el Sccafold
class _TerminosCondicionesState extends State<TerminosCondicionesUser> {
  bool? checked = false;
