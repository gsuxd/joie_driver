...
class ReporteDaoUsuario {
  void guardarReporte(ReporteUsuario reporte,) {
    ...
    final DatabaseReference _reporteRefGeneral = FirebaseDatabase.instance.ref().child(
        "reportes/usuarios/$usuario_receptor");
    final DatabaseReference _reporteRef = FirebaseDatabase.instance.ref().child(
  ...
  static Query obtenerReporte(int orden) {
    if (orden == 0) {
      print("fecha");
      final Query _reporteRef = FirebaseDatabase.instance.ref().child(
