...
class MapaMenuUsuario extends StatefulWidget {
  ...
  MapaMenuUsuario(
      {required double this.latitude, required double this.longitude});
...
class _MapaMenuState extends State<MapaMenuUsuario> {
  ...
  _MapaMenuState(
      ...
      int this.notificacion_reporte = 0});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(bottom: 10, left: 0, child: bottomNavBar(context)),
          Positioned(
            bottom: 100,
          ...
          Positioned(
            ...
            child: const Center(
              child: Text(
                "Solicitar Viaje",
                style: TextStyle(
                    color: blue, fontFamily: "Monserrat", fontSize: 18.0),
              ),
            ),
          ),
          Positioned(bottom: 20.0, left: 0.0, child: alert()),
        ],
      ),
    );
  }
  ...
  Widget alert() {
    return Visibility(
      ...
      child: Container(
        ...
        padding:
            const EdgeInsets.only(top: 10, bottom: 20.0, left: 10, right: 0.0),
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  "Su reporte ha sido recibido, en breve atenderemos su problema",
                  style: const TextStyle(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MapaSecontUsuario(
                      state: state,
                      longitude: longitude,
                      latitude: latitude,
                    )));
