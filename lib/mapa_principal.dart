...
class _MapaMenuState extends State<MapaMenu> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            bottom: 80,
            left: 0,
            child: requestClient(context, "Andrea Guzman", 50.0,
                "assets/images/estrella5.png", "assets/images/girld2.jpg"),
          ),
        ],
      ),
    );
  ...
  Visibility requestClient(BuildContext context, String name, double mount,
      String rate, String url_img) {
    return Visibility(
