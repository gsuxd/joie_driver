...
import 'package:joiedriver/register_login_emprendedor/registro/registro.dart';
import 'package:joiedriver/register_login_emprendedor/termin_y_condiciones/terminos_y_condiciones.dart';
import 'package:joiedriver/register_login_user/registro/registro.dart';
              ...
              selectType(
                  () => {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const TerminosCondicionesChofer()))
                      },
