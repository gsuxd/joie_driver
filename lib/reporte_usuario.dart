class ReporteUsuario {
  ...
  ReporteUsuario(
      {required this.n_reportes,
      required this.calificacionn,
      required this.usuario_receptor,
      required this.nombre_apellido,
      required this.category,
      required this.descripcion,
      required this.fecha,
      required this.usuario_emisor});

  ReporteUsuario.fromJson(Map<dynamic, dynamic> json,
      {this.descripcion = " ",
  ...
  ReporteUsuario.fromJsonIndividual(
    Map<dynamic, dynamic> json, {
    this.calificacionn = 0.0,
    this.usuario_receptor = "",
    this.n_reportes = 0,
